...
async function testV2Paths() {
    ...
    const candidates = [
        { url: '/uapi/domestic-stock/v1/ranking/investor-net-purchase', tr_id: 'FHPST01740000', scr: '20174' },
        { url: '/uapi/domestic-stock/v1/quotations/ranking/investor', tr_id: 'FHPST01760000', scr: '20176' },
        { url: '/uapi/domestic-stock/v1/quotations/investor-net-purchase', tr_id: 'FHPST01740000', scr: '20174' },
        { url: '/uapi/domestic-stock/v1/ranking/investor-buy-ranking', tr_id: 'FHPST01760000', scr: '20176' }
    ];
        ...
        try {
            ...
            const res = await axios.get(`${KIS_BASE_URL}${c.url}`, {
                ...
                params: {
                    ...
                    FID_INPUT_ISCD: '0008', // TRY PENSION DIRECTLY
                    FID_DIV_CLS_CODE: '0',
